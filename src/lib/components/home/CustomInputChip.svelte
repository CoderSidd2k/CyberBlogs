<script lang="ts">
	...
	export let validation = (elem:any) => true;
	...
	function addChip(event: { preventDefault: () => void; }) {
	...
	function removeChip(event: MouseEvent & { currentTarget: EventTarget & HTMLButtonElement; }, chipIndex: number, chipValue: string) {
